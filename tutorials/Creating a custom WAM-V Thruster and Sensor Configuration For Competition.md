...
## Compliance
Next, let's see how compliance works. As of July 10, 2019 there are 3 main compliance rules
...
# Description:
`generate_wamv.launch` is a simple script that takes in thruster and sensor configurations YAML file as input and outputs a urdf file to be used in simulation. It also checks to see if the thrusters and sensors are in compliance as defined by `compliance.py`.
